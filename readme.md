...
3. [API](#api)
    1. [`Perdido.utils`](#perdidoutils)
        1. [`utils.edit`](#utilsedit)
        2. [`utils.clearFix`](#utilsclearfix)
    2. [`Perdido.align(..)`](#perdidoalign)
    3. [`Perdido.center(..)`](#perdidocenter)
    4. [`Perdido.column(..)`](#perdidocolumn)
    5. [`Perdido.flexContainer(..)`](#perdidoflexcontainer)
    6. [`Perdido.masonryColumn(..)`](#perdidomasonrycolumn)
    7. [`Perdido.masonryWrap(..)`](#perdidomasonrywrap)
    8. [`Perdido.move(..)`](#perdidomove)
    9. [`Perdido.offset(..)`](#perdidooffset)
    10. [`Perdido.row(..)`](#perdidorow)
    11. [`Perdido.waffle(..)`](#perdidowaffle)
4. [Options](#options)
